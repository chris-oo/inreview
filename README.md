...
Each update to `main` runs the **Publish VSIX release** GitHub Actions workflow.
The workflow publishes a GitHub Release with separate VSIX files for the x64
and arm64 variants of Linux, macOS, and Windows.
